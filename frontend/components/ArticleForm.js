...
export default function ArticleForm({
  ...
  const onSubmit = evt => {
    ...
    setValues(initialFormValues); // Resets the form after submission
    setCurrentArticleId(null); // Ensure this resets the form to "create" mode
  };
  ...
  return (
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        <button disabled={isDisabled()} id="submitArticle"> Submit
        </button>
        {currentArticleId && (
          <button
            type="button"
